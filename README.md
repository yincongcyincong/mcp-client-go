...
| aws	                 | An MCP server implementation for retrieving information from the AWS Knowledge Base using the Bedrock Agent Runtime.                                                                                          | [doc](https://github.com/modelcontextprotocol/servers/tree/main/src/aws-kb-retrieval-server) | [aws](https://github.com/yincongcyincong/mcp-client-go/blob/main/demo/client/aws/aws.go)                                     |
