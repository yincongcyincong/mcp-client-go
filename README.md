...
| victoriametrics	     | A Model Context Protocol server that provide access to victoria metrics databases.                                                                                                                            | [doc](https://github.com/yincongcyincong/VictoriaMetrics-mcp-server)                    |                   |
